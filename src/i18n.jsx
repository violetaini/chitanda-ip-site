...
const messages = {
  'zh-CN': {
    ...
    api: {
      ...
      myip: '纯 IP 回显',
      myipDescription: '只返回当前访问者 IP，适合脚本、探针和轻量健康检查。',
      health: '服务健康',
  ...
  'en-US': {
    ...
    api: {
      ...
      myip: 'Plain IP Echo',
      myipDescription: 'Returns only the current visitor IP, useful for scripts, probes, and lightweight health checks.',
...
messages[JA_LOCALE] = mergeMessages(messages[EN_LOCALE], {
  ...
  api: {
    ...
    myip: 'プレーン IP 応答',
    myipDescription: '現在の訪問者 IP のみを返します。',
    health: 'サービスヘルス',
